...
%DATAFILTERING This function recalls "CutPoints" function (which cut the 
% cloud points) and plots the new cloud points, thus highlighting the 
% figure of the pallet.
...
% Cut the points to highlight the pallet figure
