...
mainFolder = {'Calibration20220922_14_23_47_135', 'Calibration20220922_14_25_02_597'}; % Datasets to choose from
addpath(genpath(pwd))
...
if data_choice == 1
    ...
    fileinfo = dir('Project_Material/Datasets/Calibration20220922_14_23_47_135/*.png');  % get list of files in current directory
    addpath("Project_Material/Datasets/Calibration20220922_14_23_47_135")
...
elseif data_choice == 2
    ...
    % Equalize camera images
    fileinfo = dir('Project_Material/Datasets/Calibration20220922_14_25_02_597/*.png');  % get list of files in current directory
    addpath("Project_Material/Datasets/Calibration20220922_14_25_02_597")
    thisfilename = struct('Image1', fileinfo(1).name, 'Image2', fileinfo(2).name, 'Image3', fileinfo(3).name);
    images = fieldnames(thisfilename);
    cam = [0 1 2];
